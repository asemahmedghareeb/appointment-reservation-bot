...
async function run() {
  ...
  console.log(
    'Waiting for login to complete (please complete Cloudflare / OTP if prompted in the opened window)...'
  );
  try {
    ...
    console.log('Proceeding to country pages...');
  }
  ...
  for (const country of COUNTRIES) {
    ...
    try {
      ...
      if (await centreSelect.isVisible({ timeout: 6000 })) {
