  ...
  async getCaseDetail(caseId: string): Promise<OperationsCaseDetail> {
    ...
    const applicants: OperationsCaseApplicant[] = bookingCase.bookingApplicants.map((ba) => {
      ...
      return {
        ...
        phoneCountryCode: ba.applicant.phoneCountryCode ?? null,
        phoneNumber: ba.applicant.phoneNumber ?? null,
    ...
    return {
      ...
      appointmentSelectionMode: (bookingCase.appointmentSelectionMode as any) ?? undefined,
      ...
      preferredDate: bookingCase.preferredDate ? bookingCase.preferredDate.toISOString().split('T')[0] : null,
      preferredTime: bookingCase.preferredTime ?? null,
      preferredTimeFrom: bookingCase.preferredTimeFrom ?? null,
      preferredTimeTo: bookingCase.preferredTimeTo ?? null,
      acceptAnyAvailableTime: bookingCase.acceptAnyAvailableTime,
      appointmentType: bookingCase.appointmentType ?? null,
      servicesJson: (bookingCase.servicesJson as any) ?? null,
      providerTermsAccepted: bookingCase.providerTermsAccepted,
      termsAcceptedAt: bookingCase.termsAcceptedAt?.toISOString() ?? null,
      marketingConsent: bookingCase.marketingConsent,
      marketingConsentAt: bookingCase.marketingConsentAt?.toISOString() ?? null,
      providerServiceFee: bookingCase.providerServiceFee ? Number(bookingCase.providerServiceFee) : null,
      optionalServicesTotal: bookingCase.optionalServicesTotal ? Number(bookingCase.optionalServicesTotal) : null,
      additionalFees: bookingCase.additionalFees ? Number(bookingCase.additionalFees) : null,
      totalAmount: bookingCase.totalAmount ? Number(bookingCase.totalAmount) : null,
      currency: bookingCase.currency ?? null,
      feeCapturedAt: bookingCase.feeCapturedAt?.toISOString() ?? null,
